 ...
 * パスワード：3257
 */
public class LockColor extends JDialog {
    ...
    private static final String BACKGROUND_IMAGE_PATH = "assets/images/Padlock/Padlock_Color.png";

    public LockColor(Window owner, Runnable onSuccess) {
        ...
        JButton checkBtn = new JButton("照合");
